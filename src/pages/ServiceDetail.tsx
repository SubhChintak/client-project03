...
export default function ServiceDetail() {
  ...
  const renderSpecialContent = () => {
    if (serviceId === "clinics") {
      return (
        <div className="mt-10">
          <h2 className="text-2xl font-bold mb-6 text-green-400 dark:text-green-400">Our Specialist Doctors</h2>
            ...
            {doctors.map((doctor) => (
              <Card key={doctor.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardHeader className="p-4">
                  <CardTitle className="text-lg text-green-600 dark:text-green-400">{doctor.name}</CardTitle>
                ...
                <CardContent className="p-4 pt-0 space-y-2 text-sm">
                  ...
                  <Badge className="bg-green-100 text-green-800 hover:bg-green-200 mt-2">{doctor.experience}</Badge>
                </CardContent>
      ...
      return (
        <div className="mt-10">
          <h2 className="text-2xl font-bold mb-6 text-green-400 dark:text-green-400">Our Diagnostic Centers</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {diagnosticCenters.map((center) => (
              <Card key={center.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardHeader className="p-4">
                  <CardTitle className="text-lg text-green-600 dark:text-green-400">{center.name}</CardTitle>
                  <CardDescription className="flex items-center">
                ...
                <CardFooter className="p-4 pt-0">
                  <Button className="w-full bg-green-600 hover:bg-green-700">Book Test</Button>
                </CardFooter>
              </Card>
            ))}
          </div>
      ...
      return (
        <div className="mt-10">
          <h2 className="text-2xl font-bold mb-6 text-green-400 dark:text-green-400">Our Partner Hospitals</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {hospitals.map((hospital) => (
              <Card key={hospital.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardFooter className="p-4 pt-0">
                  <Button className="w-full bg-green-600 hover:bg-green-700">View Hospital</Button>
                </CardFooter>
              </Card>
            ))}
          </div>
    ...
    return (
      <div className={`rounded-xl mt-10 shadow-lg p-6 md:p-8 ${
        serviceInfo.isPremium 
          ? "bg-gradient-to-br from-green-950 to-green-900 text-white" 
        ...
        <div className="mt-8">
          <Button className={`px-6 py-2 ${
            serviceInfo.isPremium 
              ? "bg-green-500 hover:bg-green-600 text-green-950 font-semibold" 
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen flex flex-col">
        ...
        <div className={`py-12 pt-24 ${serviceInfo.isPremium ? 'bg-gradient-to-b from-green-950 to-green-900' : ''}`}>
          <div className="container mx-auto px-4">
            ...
            {!serviceId && (
              <div className="text-center py-12">
                ...
                <Link to="/">
                  <Button className="mt-6 bg-green-500 hover:bg-green-600 text-green-950 font-semibold">
                    Return to Home
                  </Button>
                </Link>
              </div>
