...
const Index = () => {
  ...
  const marqueeMessages = [
    ...
    "Connect with Top Specialists Across India",
    "Exclusive Discounts on Health Checkups",
    "International Patient Services",
    "Second Opinion from Leading Experts"
  ];
  ...
  return (
    <ThemeProvider>
      ...
      {/* <div className="min-h-screen flex flex-col bg-lime-400 dark:bg-black"> */}
        <Navbar />
{/*         <div className="pt-20">
  ...
  Your browser does not support the video!
          ...
          <div className="container mx-auto px-4 py-10 sm:px-6 relative z-10">
            <div className="max-w-3xl">
              ...
              >
                Your Health Journey, <span className="text-lime-950/95">Our Priority</span>
              </motion.h1>
              <motion.p 
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Our Healthcare <span className="text-lime-600 dark:text-lime-400">Services</span>
              </h2>
            ...
            {isMobile && (
              <div className="mt-10 text-center">
                <Button 
                  ...
                  className="bg-lime-500 hover:bg-lime-600 text-lime-950 px-6 py-6 rounded-md shadow-md hover:shadow-lg transition-all flex items-center space-x-2"
                >
        ...
        {/* <section className="py-20 bg-lime-400 dark:bg-black"> */}
          <div className="container mx-auto px-4 sm:px-6">
            <motion.div 
              className="text-center mb-16"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Why Choose <span className="text-lime-600 dark:text-lime-400">CureXpert India</span>
              </h2>
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <motion.div 
                ...
                viewport={{ once: true, amount: 0.2 }}
              >
                <div className="bg-lime-500 dark:bg-lime-800 w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-6 shadow-lg">
                  <svg className="w-10 h-10 text-lime-900 dark:text-lime-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
