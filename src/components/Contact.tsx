...
export default function Contact() {
  ...
  return (
    ...
    {/* <section id="contact" className="py-16 bg-lime-400 dark:bg-black text-gray-900 dark:text-white"> */}
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-left mb-12">
          <h2 className="text-4xl font-bold mb-4 inline-block border-b-4 border-lime-400 pb-2">
            Get In Touch
          </h2>
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Button 
                onClick={handleCall}
                className="bg-lime-600 hover:bg-lime-700 text-white px-6 py-3 rounded-md shadow-lg hover:shadow-xl transition-all"
              >
              ...
              <Button 
                ...
                className="bg-transparent hover:bg-healthcare-900/20 border-2 border-lime-500 text-gray-900 dark:text-white px-6 py-3 rounded-md shadow-md hover:shadow-lg transition-all"
              >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-white dark:bg-gray-800 p-2 shadow-xl rounded-md border border-gray-200 dark:border-gray-700">
                  ...
                  >
                    <MapPin className="mr-2 h-4 w-4 text-lime-600" /> Agartala
                  </DropdownMenuItem>
                  <DropdownMenuItem 
                    className="flex items-center p-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md"
                    onClick={() => handleGetDirections(locations.udaipur)}
                  >
                    <MapPin className="mr-2 h-4 w-4 text-lime-600" /> Udaipur
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          ...
          <div className="flex items-center gap-4 mb-4 pt-5">
              ...
              <Button 
                variant={selectedLocation === 'agartala' ? 'default' : 'outline'}
                onClick={() => handleSelectLocation('agartala')}
                className={`px-4 py-2 ${selectedLocation === 'agartala' ? 'bg-lime-600 text-white' : 'border-lime-500'}`}
              >
                <MapPin className="mr-2 h-4 w-4" /> Agartala
              </Button>
              <Button 
                variant={selectedLocation === 'udaipur' ? 'default' : 'outline'}
                onClick={() => handleSelectLocation('udaipur')}
                className={`px-4 py-2 ${selectedLocation === 'udaipur' ? 'bg-lime-600 text-white' : 'border-lime-500'}`}
              >
                <MapPin className="mr-2 h-4 w-4" /> Udaipur
              </Button>
            </div>
