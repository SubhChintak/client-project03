      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            What Medical <span className="text-lime-600 dark:text-lime-400">Professionals</span> Say
          </h2>
                ...
                <Card className="bg-stone-200 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl border border-gray-100 dark:border-gray-700 h-full flex flex-col">
                  <CardContent className="p-6">
                    <div className="relative mb-8">
                      <QuoteIcon className="absolute -top-3 -left-2 w-8 h-8 text-lime-900 dark:text-lime-400 opacity-50" />
                    ...
                    <div className="flex items-center mt-auto pt-4 border-t border-gray-100 dark:border-gray-700">
                      <Avatar className="h-12 w-12 border-2 border-healthcare-100 dark:border-healthcare-800 shadow-md">
                        <AvatarImage src={doctor.image} alt={doctor.name} />
                        <AvatarFallback className="bg-healthcare-100 text-healthcare-600 font-bold text-xl dark:bg-healthcare-900 dark:text-healthcare-400">
                          {doctor.name.split(' ').map(n => n[0]).join('')}
                        </AvatarFallback>
                      </Avatar>
                      <div className="ml-4">
                        <h4 className="font-semibold text-gray-900 dark:text-white">{doctor.name}</h4>
                        <p className="text-lime-600 dark:text-lime-400 text-sm">{doctor.specialty}</p>
