  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isPremium 
          ? "bg-gradient-to-br from-lime-950 to-lime-900 dark:from-lime-950 dark:to-lime-900 border border-lime-800 dark:border-lime-800 shadow-lg"
    ...
    >
      <div className={cn(
        ...
        isPremium 
          ? "bg-lime-900 dark:bg-lime-900 text-lime-400"
      ...
      {isPremium && (
        <div className="mt-4 text-xs text-lime-400 font-semibold flex items-center">
