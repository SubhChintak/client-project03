      ...
      <div className="min-h-screen flex flex-col bg-stone-200 dark:bg-black">
        ...
        <div className="container mx-auto px-4 py-12 mt-16">
          <div className="flex items-center mb-8">
            <Link to="/" className="flex items-center text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 transition-colors">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold mb-2 text-gray-900 dark:text-white">
              <span className="text-green-600 dark:text-green-400">{specialtyName}</span> Specialists
            </h1>
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-1/3 lg:w-1/4 relative">
                    ...
                    <div className="absolute top-4 right-4 bg-green-500 text-white px-2 py-1 rounded-md text-sm font-medium">
                      {doctor.experience}
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {doctor.availableDates.map((day, idx) => (
                            <Badge key={idx} variant="outline" className="bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800">
                              {day}
                            </Badge>
                          ))}
                        </div>
                          ...
                          <div className="space-y-2">
                            {doctor.specialDates.map((specialDate, idx) => (
                              <div key={idx} className="text-sm border-l-2 border-green-500 pl-3 py-1">
                                <span className="font-medium text-green-600 dark:text-green-400">{specialDate.date}</span>
