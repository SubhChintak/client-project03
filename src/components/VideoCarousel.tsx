...
export default function VideoCarousel() {
  ...
  return (
    ...
    {/* <section className="py-20 bg-lime-400 dark:bg-black overflow-hidden w-full"> */}
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Featured <span className="text-lime-600 dark:text-lime-400">Videos</span>
          </h2>
        ...
        >
                  ...
                  <CardContent className="p-6 flex-grow flex flex-col">
                    <div className="relative aspect-video bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden mb-4">
                      {activeVideo === video.id ? (
                        ...
                        >
                          {/* <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-lime-800/80 to-lime-600/80 hover:from-lime-800/70 hover:to-lime-600/70 transition-all duration-300"> */}
          ...
          <div className="flex justify-center mt-8 gap-4">
            <CarouselPrevious className="static translate-y-0 mr-2 bg-lime-500 text-white hover:bg-lime-600 border-none" />
            <CarouselNext className="static translate-y-0 ml-2 bg-lime-500 text-white hover:bg-lime-600 border-none" />
          </div>
        </Carousel>
      </div>
      
      {/* Background decorative elements */}
      <div className="absolute top-0 right-0 -mr-40 -mt-40 w-96 h-96 rounded-full bg-lime-100/50 dark:bg-lime-900/20 blur-3xl z-0"></div>
      <div className="absolute bottom-0 left-0 -ml-40 -mb-40 w-96 h-96 rounded-full bg-lime-100/50 dark:bg-lime-900/20 blur-3xl z-0"></div>
    </section>
  );
}
